Module Module1
    ...
    Public Sub Main()
        ...
        Dim RandomWinner As Integer = Rand.Next(0, 101)
        ...
        If Overtime = "Y" Then
            ...
            OvertimeChance = Rand.Next(0, 101)
            Console.WriteLine(OvertimeChance)
                ...
                If OvertimeFormat = "1" Then
                    ...
                    If Team1Score = OvertimeMaxRounds And Team2Score = OvertimeMaxRounds Then
                        If RandomWinner > 50 Then
                            Team1Score = Rand.Next(OvertimeMinRounds, OvertimeMaxRounds - 2)
                            Team2Score = OvertimeMaxRounds
                        Else
                            Team2Score = Rand.Next(OvertimeMinRounds, OvertimeMaxRounds - 2)
